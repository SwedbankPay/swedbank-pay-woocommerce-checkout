...
<h3>1. <?php esc_html_e( 'Your information', WC_Swedbank_Checkout::TEXT_DOMAIN ); ?></h3>
<?php if ( $checkin_country === 'SELECT' ): ?>
<label for="checkin_country">
	<?php _e( 'Choose your country', WC_Swedbank_Checkout::TEXT_DOMAIN ); ?>
...
<div id="swedbank-checkin">
	<div class="consumer-info">
		<?php if ($consumer_data && $consumer_profile): ?>
			<div id="swedbank-consumer-profile" data-reference="<?php esc_html_e( $consumer_profile ); ?>"></div>
			<!-- <strong>
				<?php esc_html_e( 'You\'re logged in as Swedbank Pay customer.', WC_Swedbank_Checkout::TEXT_DOMAIN ); ?>
			</strong>
			<p>
